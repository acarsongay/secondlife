...
string remove_whitespace_alt( string common ) {
    integer index;
    while(~index = llSubStringIndex((string) common, (string) " ")) {
...
default {
	state_entry() {
        ...
        common = (string) lindon_lab_get_inventory_key( (string) common );
        common = (string) lindon_lab_get_notecard_line( (string) common ); 
        */
        //EngineLevel
        ...
        */
        ...
        common = (string) llJsonSetValue( (string) common, (list) "string_json", (string) JSON_STRING );
        common = (string) llJsonSetValue( (string) common, (list) "string_err", (string) JSON_STRING );
        common = (string) llJsonSetValue( (string) common, (list) "string_name", (string) "notecard.json" );
        common = (string) llJsonSetValue( (string) common, (list) "integer_line", (string) 0 );
        common = (string) llJsonSetValue( (string) common, (list) "key_handle", (string) NULL_KEY);
        common = (string) llJsonSetValue( (string) common, (list) "key_UUID", (string) NULL_KEY);
        common = (string) llJsonSetValue( (string) common, (list) "string_notecard", (string) "" ); 
        common = (string) llJsonSetValue( (string) common, (list) "string_json", (string) common);
        */
        //EndEngineLevel
        ...
        json = (string) lindon_lab_get_inventory_key( (string) json );
        json = (string) lindon_lab_get_notecard_line( (string) json );
